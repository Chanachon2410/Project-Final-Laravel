                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ภาคเรียน/ปี</th>
                                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">ยอดชำระ (บาท)</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">กำหนดชำระ</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">ลงทะเบียน/พิมพ์ใบแจ้งหนี้</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($structures as $struct)
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-indigo-600">{{ $struct->name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $struct->semester }}/{{ $struct->year }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right font-bold">{{ number_format($struct->total_amount, 2) }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <button wire:click="selectStructure({{ $struct->id }})" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 text-xs font-bold shadow-sm transition flex items-center gap-2 mx-auto">
