                                                                                                                    ...
                                                                                                                    @if ($registration)
                                                                                                                        <div class="relative inline-block text-left"
                                                                                                                            ...
                                                                                                                            <div x-show="open" @click.away="open = false"
                                                                                                                                ...
                                                                                                                                <div class="py-1">
                                                                                                                                    <button
                                                                                                                                        wire:click="updateStatus({{ $registration->id }}, 'pending')"
                                                                                                                                        @click="open = false"
                                                                                                                        ...
                                                                                                                        <div class="relative inline-block text-left"
                                                                                                                            ...
                                                                                                                            <div x-show="open" @click.away="open = false"
                                                                                                                                ...
                                                                                                                                <div class="py-1">
                                                                                                                                    ...
                                                                                                                                    <button
                                                                                                                                        wire:click="updateStatus(null, 'approved', {{ $student->id }})"
                                                                                                                                        @click="open = false"
                                                                                                                                        class="flex items-center w-full px-4 py-2 text-sm text-green-700 hover:bg-green-50">
                                                                                                                                    ...
                                                                                                                                    <button
                                                                                                                                        wire:click="updateStatus(null, 'pending', {{ $student->id }})"
                                                                                                                                        @click="open = false"
                                                                                                                                        class="flex items-center w-full px-4 py-2 text-sm text-yellow-700 hover:bg-yellow-50">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            @if ($selectedRegistration && $selectedRegistration->status === 'pending')
                                ...
                                <button type="button" {{-- Add Reject Logic Here if needed later --}}
