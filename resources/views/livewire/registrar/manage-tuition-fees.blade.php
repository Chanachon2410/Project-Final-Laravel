        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
                <div class="flex flex-grow w-full sm:w-auto">
                    <input type="text" wire:model="search" placeholder="Search fees..." class="block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-md rounded-r-none leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <button wire:click="create()" class="w-full sm:w-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create New Fee</button>
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="mt-4 flex justify-between items-center">
                <div class="text-sm text-gray-700">
                    @if ($tuitionFees->total() > 0)
                        Showing {{ $tuitionFees->firstItem() }} to {{ $tuitionFees->lastItem() }} of {{ $tuitionFees->total() }} results
                    @else
                        No results found
                    @endif
                </div>
