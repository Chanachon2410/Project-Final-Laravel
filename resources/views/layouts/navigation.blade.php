...
<div class="flex h-full flex-col justify-between bg-white">
    <div class="px-4 py-6">
        ...
        <div class="flex items-center h-9 mb-6" :class="sidebarCollapsed ? 'justify-center' : 'justify-between'">
            ...
            <button @click="sidebarCollapsed = !sidebarCollapsed" class="hidden md:block p-1.5 rounded-md border border-gray-200 text-gray-500 hover:bg-gray-100 hover:text-gray-700 focus:outline-none transition-colors">
